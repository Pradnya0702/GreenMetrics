...
product_list = [
    ...
    "Cyclohexanone", "Cyclopentanone", "Ethyl methyl ketone", "Acetone", "Isatin","Benzaldehyde","3 4 5(OCH3)","N N-Dimethyl","2-Thiophene","Vanilin","3 4 5(OME)3"
]
...
def ulogin():
    ...
    if request.method == 'POST' and 'username' in request.form and 'password' in request.form:
        ...
        cursor.execute('SELECT * FROM green_metrics.userlog1 WHERE username = %s AND password = %s', (username, password,))
...
def register():
    ...
    if request.method == 'POST' and 'username' in request.form and 'password' in request.form and 'email' in request.form:
        ...
        cursor = mysql.connection.cursor()
        cursor.execute('SELECT * FROM green_metrics.userlog1 WHERE username = %s', (username,))
        account = cursor.fetchone()
        ...
        if account:
            ...
            cursor.execute('INSERT INTO green_metrics.userlog1 VALUES (NULL, %s, %s, %s)', (username, password, email,))
...
def for_pass():
    ...
    if request.method == 'POST':
        ...
        password = request.form.get('password')
        cursor = mysql.connection.cursor()
        cursor.execute('UPDATE green_metrics.userlog1 SET password = %s WHERE email = %s', (password, email,))
        mysql.connection.commit()
